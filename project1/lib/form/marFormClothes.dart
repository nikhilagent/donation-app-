...
class marFormClothes extends StatefulWidget {
  const marFormClothes({Key? key}) : super(key: key);

  @override
  State<marFormClothes> createState() => _marFormClothesState();
}

class _marFormClothesState extends State<marFormClothes> {
  CollectionReference marclothes =
      FirebaseFirestore.instance.collection('marclothes');
            ...
            child: ListView(children: [
              ...
              */
              ...
              Container(
                ...
                decoration: InputDecoration(
                    border: OutlineInputBorder(),
                    hintText: 'Description Of Clothes',
                    labelText: 'Description Of Clothes',
                    prefixIcon: Icon(
                      Icons.person,
                      color: Colors.black,
                    )),
              ...
              Container(
                ...
                decoration: InputDecoration(
                    border: OutlineInputBorder(),
                    hintText: 'Quantity Of Clothes',
                    labelText: 'Quantity Of Clothes',
                    prefixIcon: Icon(
                      Icons.language,
                      color: Colors.black,
                    )),
